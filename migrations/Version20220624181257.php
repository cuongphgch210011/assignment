 ...
 */
final class Version20220624181257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, orderdetailid_id INT NOT NULL, customer_id INT NOT NULL, orderdate DATE NOT NULL, shipcity VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F52993985A50BEE (orderdetailid_id), INDEX IDX_F52993989395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993985A50BEE FOREIGN KEY (orderdetailid_id) REFERENCES `order` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F52993985A50BEE');
